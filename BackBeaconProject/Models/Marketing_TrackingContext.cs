...
{
    public partial class Marketing_TrackingContext : DbContext
    {
        public Marketing_TrackingContext()
        {
        }

        public Marketing_TrackingContext(DbContextOptions<Marketing_TrackingContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                //optionsBuilder.UseSqlServer("Server=sql02.prod.te.tld;Database=Marketing_Tracking;Trusted_Connection=false;User ID=wesleys;Password=oi49&kjHJmt%#uy_");
            }
        }
